function [lambda_perc, alpha_rad] = calcWheelSlips(omega_rad, VehicleState, DeltaWheel_rad, tw_front_m, tw_rear_m, l_front_m, l_rear_m, tyreradius_front_m, tyreradius_rear_m)
...
% calculate tireslips
lambda_perc = 100*(v_wheel-v_ref)./(v_ref); 
