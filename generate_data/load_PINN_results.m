filename_slip_tirecoeff = "./PINN_results/slip_Tirecoeffs_FF4_lossaddnl/";
filename_vehStates = "./PINN_results/veh_states_FF4_lossaddnl/";

slip_tirecoeff_0 = readtable(filename_slip_tirecoeff + 'layer13_activations_0' + ".csv");
slip_tirecoeff_1 = readtable(filename_slip_tirecoeff + 'layer13_activations_1' + ".csv");
slip_tirecoeff_2 = readtable(filename_slip_tirecoeff + 'layer13_activations_2' + ".csv");
slip_tirecoeff_3 = readtable(filename_slip_tirecoeff + 'layer13_activations_3' + ".csv");
slip_tirecoeff_4 = readtable(filename_slip_tirecoeff + 'layer13_activations_4' + ".csv");
slip_tirecoeff_5 = readtable(filename_slip_tirecoeff + 'layer13_activations_5' + ".csv");
slip_tirecoeff_6 = readtable(filename_slip_tirecoeff + 'layer13_activations_6' + ".csv");
slip_tirecoeff_7 = readtable(filename_slip_tirecoeff + 'layer13_activations_7' + ".csv");
slip_tirecoeff_8 = readtable(filename_slip_tirecoeff + 'layer13_activations_8' + ".csv");
slip_tirecoeff_9 = readtable(filename_slip_tirecoeff + 'layer13_activations_9' + ".csv");
slip_tirecoeff_10 = readtable(filename_slip_tirecoeff + 'layer13_activations_10' + ".csv");
slip_tirecoeff_11 = readtable(filename_slip_tirecoeff + 'layer13_activations_11' + ".csv");
slip_tirecoeff_12 = readtable(filename_slip_tirecoeff + 'layer13_activations_12' + ".csv");
slip_tirecoeff_13 = readtable(filename_slip_tirecoeff + 'layer13_activations_13' + ".csv");
% slip_tirecoeff_14 = readtable(filename_slip_tirecoeff + 'layer13_activations_14' + ".csv");
% slip_tirecoeff_15 = readtable(filename_slip_tirecoeff + 'layer13_activations_15' + ".csv");
...
slip_tirecoeff_PINN = [slip_tirecoeff_0;slip_tirecoeff_1;slip_tirecoeff_2;slip_tirecoeff_3;slip_tirecoeff_4;slip_tirecoeff_5;slip_tirecoeff_6;slip_tirecoeff_7;slip_tirecoeff_8;slip_tirecoeff_9; slip_tirecoeff_10; slip_tirecoeff_11; slip_tirecoeff_12; slip_tirecoeff_13];% slip_tirecoeff_14; slip_tirecoeff_15];
vehStates_PINN = [vehStates_0;vehStates_1;vehStates_2;vehStates_3;vehStates_4;vehStates_5;vehStates_6;vehStates_7;vehStates_8;vehStates_9; vehStates_10; vehStates_11; vehStates_12; vehStates_13;];% vehStates_14; vehStates_15];
