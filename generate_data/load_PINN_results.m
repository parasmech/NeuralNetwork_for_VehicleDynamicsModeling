filename_slip_tirecoeff = "./PINN_results/slip_Tirecoeffs_FF4L_newlims_predData_wtOnlatSpdYaw/";
filename_vehStates = "./PINN_results/veh_states_FF4L_newlims_predData_wtOnlatSpdYaw/";

% slip_tirecoeff = readtable(filename_vehStates + 'data_to_run_for slips' + ".csv");
