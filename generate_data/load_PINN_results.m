filename_slip_tirecoeff = "./PINN_results/slip_Tirecoeffs_FF9L_60_oldlims_sliploss_LongSlipWt1k_re/";
filename_vehStates = "./PINN_results/veh_states_FF9L_60_oldlims_sliploss_LongSlipWt1k_re/";

slip_tirecoeff = readtable(filename_slip_tirecoeff + 'data_to_run_for slips' + ".csv");
slip_tirecoeff_0 = readtable(filename_slip_tirecoeff + 'layer11_activations_0' + ".csv");
slip_tirecoeff_1 = readtable(filename_slip_tirecoeff + 'layer11_activations_1' + ".csv");
slip_tirecoeff_2 = readtable(filename_slip_tirecoeff + 'layer11_activations_2' + ".csv");
slip_tirecoeff_3 = readtable(filename_slip_tirecoeff + 'layer11_activations_3' + ".csv");
slip_tirecoeff_4 = readtable(filename_slip_tirecoeff + 'layer11_activations_4' + ".csv");
slip_tirecoeff_5 = readtable(filename_slip_tirecoeff + 'layer11_activations_5' + ".csv");
slip_tirecoeff_6 = readtable(filename_slip_tirecoeff + 'layer11_activations_6' + ".csv");
slip_tirecoeff_7 = readtable(filename_slip_tirecoeff + 'layer11_activations_7' + ".csv");
slip_tirecoeff_8 = readtable(filename_slip_tirecoeff + 'layer11_activations_8' + ".csv");
slip_tirecoeff_9 = readtable(filename_slip_tirecoeff + 'layer11_activations_9' + ".csv");
slip_tirecoeff_10 = readtable(filename_slip_tirecoeff + 'layer11_activations_10' + ".csv");
slip_tirecoeff_11 = readtable(filename_slip_tirecoeff + 'layer11_activations_11' + ".csv");
slip_tirecoeff_12 = readtable(filename_slip_tirecoeff + 'layer11_activations_12' + ".csv");
slip_tirecoeff_13 = readtable(filename_slip_tirecoeff + 'layer11_activations_13' + ".csv");
slip_tirecoeff_14 = readtable(filename_slip_tirecoeff + 'layer11_activations_14' + ".csv");
slip_tirecoeff_15 = readtable(filename_slip_tirecoeff + 'layer11_activations_15' + ".csv");
slip_tirecoeff_16 = readtable(filename_slip_tirecoeff + 'layer11_activations_16' + ".csv");
slip_tirecoeff_17 = readtable(filename_slip_tirecoeff + 'layer11_activations_17' + ".csv");
slip_tirecoeff_18 = readtable(filename_slip_tirecoeff + 'layer11_activations_18' + ".csv");
slip_tirecoeff_19 = readtable(filename_slip_tirecoeff + 'layer11_activations_19' + ".csv");
...
% long_slip_front_PINN = timeseries(slip_tirecoeff.lambdaF , tiSer); 
% long_slip_rear_PINN = timeseries(slip_tirecoeff.lambdaR , tiSer); 
% lat_slip_front_PINN = timeseries(slip_tirecoeff.alpharadF, tiSer); 
% lat_slip_rear_PINN = timeseries(slip_tirecoeff.alpharadR , tiSer); 
